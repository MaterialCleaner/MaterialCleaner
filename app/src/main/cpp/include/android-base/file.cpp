...
namespace android {
    namespace base {
        ...
        bool
        WriteFullyAtOffset(borrowed_fd fd, const void *data, size_t byte_count, off64_t offset) {
...
// Copied from bionic so that Basename() below can be portable and thread-safe.
        static int
        _basename_r(const char *path, size_t path_size, char *buffer, size_t buffer_size) {
...
// Copied from bionic so that Dirname() below can be portable and thread-safe.
        static int
        _dirname_r(const char *path, size_t path_size, char *buffer, size_t buffer_size) {
            const char *endp = nullptr;
            int len;
            int result;
