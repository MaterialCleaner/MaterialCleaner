...
public enum TimeUnitCompat {
     ...
     */
    NANOSECONDS(TimeUnitCompat.NANO_SCALE),
    /**
     * Time unit representing one thousandth of a millisecond.
     */
    MICROSECONDS(TimeUnitCompat.MICRO_SCALE),
    /**
     * Time unit representing one thousandth of a second.
     */
    MILLISECONDS(TimeUnitCompat.MILLI_SCALE),
    /**
     * Time unit representing one second.
     */
    SECONDS(TimeUnitCompat.SECOND_SCALE),
    /**
     * Time unit representing sixty seconds.
     *
     * @since 1.6
     */
    MINUTES(TimeUnitCompat.MINUTE_SCALE),
    /**
     * Time unit representing sixty minutes.
     *
     * @since 1.6
     */
    HOURS(TimeUnitCompat.HOUR_SCALE),
    /**
     ...
     */
    public long convert(long sourceDuration, TimeUnitCompat sourceUnit) {
        switch (this) {
            case NANOSECONDS:
     ...
     * @apiNote This method differs from {@link Duration#toNanos()} in that it
    ...
    /**
     * Equivalent to
     * {@link #convert(long, TimeUnitCompat) NANOSECONDS.convert(duration, this)}.
     *
    ...
    /**
     * Equivalent to
     * {@link #convert(long, TimeUnitCompat) MICROSECONDS.convert(duration, this)}.
     *
     * @param duration the duration
     * @return the converted duration,
     * or {@code Long.MIN_VALUE} if conversion would negatively overflow,
    ...
    /**
     * Equivalent to
     * {@link #convert(long, TimeUnitCompat) MILLISECONDS.convert(duration, this)}.
     *
     * @param duration the duration
     * @return the converted duration,
     * or {@code Long.MIN_VALUE} if conversion would negatively overflow,
    ...
    /**
     * Equivalent to
     * {@link #convert(long, TimeUnitCompat) SECONDS.convert(duration, this)}.
     *
     * @param duration the duration
     * @return the converted duration,
     * or {@code Long.MIN_VALUE} if conversion would negatively overflow,
    ...
    /**
     * Equivalent to
     * {@link #convert(long, TimeUnitCompat) MINUTES.convert(duration, this)}.
     *
     * @param duration the duration
     * @return the converted duration,
     * or {@code Long.MIN_VALUE} if conversion would negatively overflow,
    ...
    /**
     * Equivalent to
     * {@link #convert(long, TimeUnitCompat) HOURS.convert(duration, this)}.
     *
     * @param duration the duration
     * @return the converted duration,
     * or {@code Long.MIN_VALUE} if conversion would negatively overflow,
    ...
    /**
     * Equivalent to
     * {@link #convert(long, TimeUnitCompat) DAYS.convert(duration, this)}.
     *
     * @param duration the duration
     * @return the converted duration
     * @since 1.6
     ...
     * (see {@link BlockingQueue#poll(long, TimeUnitCompat) BlockingQueue.poll})
     * using:
     *
     * <pre> {@code
     ...
     * @since 9
     */
    public static TimeUnitCompat of(ChronoUnit chronoUnit) {
        switch (Objects.requireNonNull(chronoUnit, "chronoUnit")) {
            case NANOS:
                return TimeUnitCompat.NANOSECONDS;
            case MICROS:
                return TimeUnitCompat.MICROSECONDS;
            case MILLIS:
                return TimeUnitCompat.MILLISECONDS;
            case SECONDS:
                return TimeUnitCompat.SECONDS;
            case MINUTES:
                return TimeUnitCompat.MINUTES;
            case HOURS:
                return TimeUnitCompat.HOURS;
            case DAYS:
                return TimeUnitCompat.DAYS;
            default:
